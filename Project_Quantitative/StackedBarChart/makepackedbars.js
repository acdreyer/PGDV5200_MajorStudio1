...
makePackedBarsFromData = function(inArgs) {
    ...
    if (arg.chartTitle === null)
        // arg.chartTitle = "The MET collection " + nRows + " of " + nCategory + " " + arg.categoryDataName + " " + arg.valueDataName;
 arg.chartTitle = "The MET collection: " + arg.categoryDataName + " " + arg.valueDataName;
